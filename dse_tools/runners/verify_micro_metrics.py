...
def main():
    ...
    os.makedirs(os.path.join(os.path.dirname(__file__), '..', '..', 'reports', 'uniform_dse', 'data'), exist_ok=True)
    with open(os.path.join(os.path.dirname(__file__), '..', '..', 'reports', 'uniform_dse', 'data', 'micro_metrics_results.json'), 'w') as f:
