...
def generate_markdown_table():
    try:
        with open(os.path.join(os.path.dirname(os.path.dirname(__file__)), "..", "reports", "uniform_dse", "data", "verification_results.json"), 'r', encoding='utf-8') as f:
            results = json.load(f)
    ...
    with open(os.path.join(os.path.dirname(os.path.dirname(__file__)), "..", "reports", "uniform_dse", "docs", "verification_summary.md"), 'w', encoding='utf-8') as f:
        f.write(md)

if __name__ == "__main__":
    generate_markdown_table()
    print("Markdown 報告產生完畢：reports/uniform_dse/docs/verification_summary.md")
